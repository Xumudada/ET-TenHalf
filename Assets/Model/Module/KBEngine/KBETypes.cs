...
namespace KBEngine
{
	...
	public struct Gold
	{
		...
		public static implicit operator UInt32(Gold value)
		{
			return value.value;
		}

		public static implicit operator Gold(UInt32 value)
		{
			UInt32 tvalue = (UInt32)value;
			return new Gold(tvalue);
		}
	...
	public struct RoomKey
	{
		...
		RoomKey(UInt16 value)
		{
			this.value = value;
		}

		public static implicit operator UInt16(RoomKey value)
		{
			return value.value;
		}

		public static implicit operator RoomKey(UInt16 value)
		{
			UInt16 tvalue = (UInt16)value;
			return new RoomKey(tvalue);
		}
